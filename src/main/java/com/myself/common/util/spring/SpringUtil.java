package com.myself.common.util.spring;
...
//        System.out.println("-------------------------------------------");
    ...
    public static Object getApplicationProperties(String propertiesId) throws BeansException {
        String property = applicationContext.getEnvironment().getProperty(propertiesId);
        return property;
    }
